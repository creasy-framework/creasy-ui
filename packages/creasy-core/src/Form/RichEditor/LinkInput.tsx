    ...
    return (
      <div style={{ whiteSpace: 'nowrap' }}>
        <input
          ...
          type="text"
          className="creasy-toolbar__input"
          onChange={this.onLinkChange}
          value={this.state.url}
          onKeyDown={this.onLinkKeyDown}
          placeholder={msg}
        />
        <span className="creasy-toolbar__item" style={{ verticalAlign: 'bottom' }}>
          <button
            onClick={this.props.removeEntity}
            type="button"
            className="creasy-toolbar__button creasy-toolbar__input-button"
          >
