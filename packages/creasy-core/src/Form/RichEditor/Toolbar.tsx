...
export default class Toolbar extends React.Component<Props, State> {
  ...
  renderToolList() {
    return (
      <ul className="creasy-toolbar__list">
  ...
  render() {
    ...
    return (
      <div
        className={`creasy-toolbar ${show && 'creasy-toolbar--open'} ${error && 'creasy-toolbar--error'}`}
      ...
      >
        <div style={{ position: 'absolute', bottom: 0 }}>
          <div
            className="creasy-toolbar__wrapper"
            ref={(el) => {
              this.toolbarEl = el;
            }}
          >
            {this.state.editingEntity
              ...
              : this.renderToolList()}
            <p className="creasy-toolbar__error-msg">{this.state.error}</p>
            <span
              className="creasy-toolbar__arrow"
              ref={(el) => {
                this.arrowEl = el;
              }}
