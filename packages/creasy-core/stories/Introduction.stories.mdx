...
import Creasy from './assets/creasy.svg';
...
<div className="header">
  <img src={Creasy} alt="logo" />
  <h1>Welcome to Creasy UI</h1>
</div>

Creasy UI is an open source UI library built on top of react. Source code can be found from [github](https://github.com/https://github.com/creasy-framework/creasy-ui)
...
MIT © [https://github.com/creasy-framework/creasy-ui](https://github.com/creasy-framework/creasy-ui)
