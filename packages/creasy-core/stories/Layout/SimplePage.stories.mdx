...
<Meta title="Components/Layout/Simple Page" />
...
<SimplePage
  ...
  primaryContentHeader={<h3>Primary content header</h3>}
  secondaryContentHeader={<h4>Secondary content header</h4>}
  contentFooter={<h3>Content footer</h3>}
>
    <div style={{height: '60vh'}}>Content</div>
</SimplePage>
````
...
render(() => {
  ...
  return (
    <SimplePage
        ...
        primaryContentHeader={<h3>Example Page</h3>}
        contentFooter={
        <ButtonRow
          primary={[
